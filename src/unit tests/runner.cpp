...
public:
 TestDescription_suite_DimensionalSplittingTest_testDimensionalSplitting() : CxxTest::RealTestDescription( Tests_DimensionalSplittingTest, suiteDescription_DimensionalSplittingTest, 45, "testDimensionalSplitting" ) {}
